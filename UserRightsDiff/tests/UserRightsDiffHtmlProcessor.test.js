import { UserRightsDiffHtmlProcessor } from '../modules/UserRightsDiffHtmlProcessor.js';
...
const htmlProcessor = new UserRightsDiffHtmlProcessor();
...
describe( 'deleteParenthesesAndTags(text)', () => {
	test( 'Basic', () => {
		...
		expect( htmlProcessor.deleteParenthesesAndTags( text ) ).toBe( output );
	} );
